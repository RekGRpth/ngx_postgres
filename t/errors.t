...
--- http_config
    upstream database {
        postgres_server     dbname=ngx_test user=ngx_test password=wrong_pass sslmode=disable;
    }
--- config
    location /postgres {
        postgres_pass       database;
...
--- http_config
    upstream database {
        postgres_server     dbname=ngx_test user=ngx_test password=ngx_test sslmode=disable;
    }
--- config
    location /postgres {
        postgres_pass       database;
